...
<br/>
Username:<input type="text" name="save_username" value="<?php echo htmlentities($_POST['save_username'], ENT_QUOTES, 'UTF-8');?>"/>
Password: <input type='password' name="save_password" value="<?php echo htmlentities($_POST['save_password'], ENT_QUOTES, 'UTF-8');?>"/>
</div>
