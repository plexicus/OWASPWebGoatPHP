...
<?php
	...
	if (isset($_GET['file'])) //code coverage report for a single file
	{
        ...
        echo "<h3>Code Coverage Report for ".htmlspecialchars($_GET['file'], ENT_QUOTES, 'UTF-8')."</h3>\n";
        echo "<h2>Code Coverage Report for ".htmlspecialchars($_GET['file'], ENT_QUOTES, 'UTF-8')."</h2>\n";
        echo "<h4>Code Coverage Report for ".htmlspecialchars($_GET['file'], ENT_QUOTES, 'UTF-8')."</h2>\n";
